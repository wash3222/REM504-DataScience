## Nelson's Magic Package Installer
...
## !!! Note that this script was written for R running on Windows machines. Several of the packages will fail on installation to
##     Mac or Lunix machines. Examples of Windows-only packages include: RODBC, XLSX (will run on Mac), arcgisbinding !!!
